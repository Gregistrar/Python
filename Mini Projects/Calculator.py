...
class PyCalc:
    def __init__(self, master):
        ...
        self.screen = tk.Entry(self.gui, textvariable=self.equation, width=34, background='light green',
        ...
        clearbut = tk.Button(self.gui, text='Clear', fg='white', bg='black',
                             command=self.clear, height=3, width=12, font=self.custom_font)
        clearbut.grid(row=2, column=2)

        backspace = tk.Button(self.gui, text='Delete', fg='white', bg='black',
                              command=self.backspace, height=3, width=12, font=self.custom_font)
        backspace.grid(row=2, column=3)

        # 2nd Row Buttons
        fraction = tk.Button(self.gui, text=' 1/x ', fg='white', bg='black',
                             command=lambda: self.special_functions("fraction"), height=3, width=12,
                             font=self.custom_font)
        fraction.grid(row=3, column=0)

        power = tk.Button(self.gui, text=' x² ', fg='white', bg='black',
                          command=lambda: self.special_functions("power"), height=3, width=12, font=self.custom_font)
        power.grid(row=3, column=1)

        square = tk.Button(self.gui, text=' √ ', fg='white', bg='black',
                           command=lambda: self.special_functions("sqroot"), height=3, width=12, font=self.custom_font)
        square.grid(row=3, column=2)

        divide = tk.Button(self.gui, text=' / ', fg='white', bg='black',
                           command=lambda: self.press("/"), height=3, width=12, font=self.custom_font)
        divide.grid(row=3, column=3)

        # 3rd Row Buttons
        button7 = tk.Button(self.gui, text=' 7 ', fg='white', bg='black',
                            command=lambda: self.press(7), height=3, width=12, font=self.custom_font)
        button7.grid(row=4, column=0)

        button8 = tk.Button(self.gui, text=' 8 ', fg='white', bg='black',
                            command=lambda: self.press(8), height=3, width=12, font=self.custom_font)
        button8.grid(row=4, column=1)

        button9 = tk.Button(self.gui, text=' 9 ', fg='white', bg='black',
                            command=lambda: self.press(9), height=3, width=12, font=self.custom_font)
        ...
        button4 = tk.Button(self.gui, text=' 4 ', fg='white', bg='black',
                            command=lambda: self.press(4), height=3, width=12, font=self.custom_font)
        button4.grid(row=5, column=0)

        button5 = tk.Button(self.gui, text=' 5 ', fg='white', bg='black',
                            command=lambda: self.press(5), height=3, width=12, font=self.custom_font)
        button5.grid(row=5, column=1)

        button6 = tk.Button(self.gui, text=' 6 ', fg='white', bg='black',
                            command=lambda: self.press(6), height=3, width=12, font=self.custom_font)
        ...
        button1 = tk.Button(self.gui, text=' 1 ', fg='white', bg='black',
                            command=lambda: self.press(1), height=3, width=12, font=self.custom_font)
        button1.grid(row=6, column=0)

        button2 = tk.Button(self.gui, text=' 2 ', fg='white', bg='black',
                            command=lambda: self.press(2), height=3, width=12, font=self.custom_font)
        button2.grid(row=6, column=1)

        button3 = tk.Button(self.gui, text=' 3 ', fg='white', bg='black',
                            command=lambda: self.press(3), height=3, width=12, font=self.custom_font)
        ...
        negate = tk.Button(self.gui, text=' +/- ', fg='white', bg='black',
                           command=self.plusminus, height=3, width=12, font=self.custom_font)
        negate.grid(row=7, column=0)

        button0 = tk.Button(self.gui, text=' 0 ', fg='white', bg='black',
                            command=lambda: self.press(0), height=3, width=12, font=self.custom_font)
        ...
        equal = tk.Button(self.gui, text=' = ', fg='white', bg='black',
                          command=self.equalpress, height=3, width=12, font=self.custom_font)
